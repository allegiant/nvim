...
vim.keymap.set({ 'n' }, "gd", "<cmd>lua require('vscode').action('editor.action.goToTypeDefinition')<CR>")
...
vim.keymap.set({ 'n' }, "gh", "<cmd>lua require('vscode').action('editor.action.showDefinitionPreviewHover')<CR>")
